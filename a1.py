...
USER_FILE = "user_choices_Macd_1.json"
CONFIG_FILE = "config_Macd_1.json"
SCREENSHOT_FOLDER = os.getenv("SCREENSHOT_FOLDER", r"C:\Users\Administrator\AppData\Roaming\MetaQuotes\Terminal\349E16B7920CFBBD33C6F7D281C20DB6\MQL5\Files\1")
TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "8486806617:AAFw_5WkaKZ13zCGNk8xqApj6CdgWXaHhlA")
...
# --- بررسی و ارسال تصاویر ---# --- بررسی و ارسال تصاویر با شماره 1 ---
    ...
    while True:
        try:
            ...
            for file in files:
                ...
                # حذف اگر شماره فایل غیر از 1 باشه
                if file_num != "1":
                    os.remove(file_path)
                    logger.info(f"❌ حذف شد (شماره فایل ≠ 1): {file}")
                    continue
